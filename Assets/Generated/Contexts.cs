...
public partial class Contexts {
    ...
    public void InitializeEntityIndices() {
        game.AddEntityIndex(new Entitas.EntityIndex<GameEntity, int>(
            Fraction,
            game.GetGroup(GameMatcher.Fraction),
            (e, c) => ((FractionComponent)c).Fraction));
    }
}

public static class ContextsExtensions {

    public static System.Collections.Generic.HashSet<GameEntity> GetEntitiesWithFraction(this GameContext context, int Fraction) {
        return ((Entitas.EntityIndex<GameEntity, int>)context.GetEntityIndex(Contexts.Fraction)).GetEntities(Fraction);
    }
}
//------------------------------------------------------------------------------
// <auto-generated>

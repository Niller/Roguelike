...
public partial class GameEntity {
    ...
    public void AddHealthBar(Assets.Scripts.Gui.HealthBarController newHealthBar) {
        var index = GameComponentsLookup.HealthBar;
        var component = (HealthBarComponent)CreateComponent(index, typeof(HealthBarComponent));
        component.HealthBar = newHealthBar;
        AddComponent(index, component);
    }

    public void ReplaceHealthBar(Assets.Scripts.Gui.HealthBarController newHealthBar) {
        var index = GameComponentsLookup.HealthBar;
        var component = (HealthBarComponent)CreateComponent(index, typeof(HealthBarComponent));
        component.HealthBar = newHealthBar;
